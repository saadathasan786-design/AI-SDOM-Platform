/**
 * Context Loader — Stage 5F. Reuses the exact same context-loading
 * pattern as vscode-advisor-extension/src/context-loader.js (Stage 4L),
 * since runAgentWithReport()'s context shape is identical: a bag of
 * inputs like { sourceFiles: [{path, content}] }. Assembles that object
 * from a user's choice of source inside VS Code. Contains NO analysis --
 * only collecting { path, content } pairs.
 *
